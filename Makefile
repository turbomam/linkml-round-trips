...
# yuck, some of these scripts use default output files, some require an output file and have no default, some use STDOUT
enums_to_curateable:
...
serializastion_vs_pattern:
	egrep "string_serialization:.*{PMID}|{DOI}|{URL}" ../mixs-source/model/schema/*yaml
